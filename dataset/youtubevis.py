...
class YouTubeVISDataset(Dataset):
    def __init__(self, videodir, annfile, size, seq_length, seq_sampler, resolution,transform=None):
        self.videodir = videodir
        self.size = size
        self.seq_length = seq_length
        self.seq_sampler = seq_sampler
        self.transform = transform
        self.to_resolution = transforms.Resize(resolution)
    ...
    def __getitem__(self, idx):
        ...
        return self.to_resolution(imgs), self.to_resolution(segs)
