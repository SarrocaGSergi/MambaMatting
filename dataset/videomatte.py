...
class VideoMatteDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if self.transform is not None:
            ...
            return self.to_resolution(fgrs), self.to_resolution(phas), self.to_resolution(bgrs)
    ...
    def _round_to_multiple(self, x, base=32):
    ...
    def _downsample_if_needed(self, img):
        ...
        w, h = img.size
        w = self._round_to_multiple(w, 64)
        h = self._round_to_multiple(h, 64)
        img = img.resize((w, h))
