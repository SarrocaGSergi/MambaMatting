...
from dataset.augmentation import TrainFrameSampler
...
dataset_train = ImageMatte(imagematte_dir="/mnt/nvme0n1/Datasets/matting-data/ImageMatte/train",
                                  background_image_dir= "/mnt/nvme0n1/Datasets/matting-data/ImageMatte/train/bgr",
                                  transform=TRANSFORM, size=(512,288), seq_length=1)
dataset_val = ImageMatte(imagematte_dir="/mnt/nvme0n1/Datasets/matting-data/ImageMatte/val",
